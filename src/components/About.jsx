      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary leading-relaxed">
            Hello! I'm a driven Full Stack Developer with a strong foundation in
          ...
          {/* <img src={profilePlaceholder} alt="Freedom Freak" className="w-40 h-40 rounded-full mx-auto my-6 border-4 border-accent-1" /> */}
        </motion.div>
